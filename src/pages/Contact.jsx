    ...
    <div className="min-h-screen flex flex-col pt-32 pb-0 bg-[#FFFFFF] pixel-grid-bg">
      ...
      <main className="flex-grow px-margin-mobile md:px-margin-desktop w-full max-w-7xl mx-auto flex flex-col justify-center overflow-x-hidden">
        <header className="mb-24 w-full text-center flex flex-col items-center">
          <h1
            className="font-headline-display text-[32px] leading-[40px] sm:text-[50px] sm:leading-[60px] md:text-[80px] lg:text-headline-display lg:leading-[110px] text-[#3300FF] mb-8 uppercase break-words max-w-full glitch-text"
